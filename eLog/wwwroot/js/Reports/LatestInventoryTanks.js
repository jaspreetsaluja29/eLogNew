...
function sortTable(columnIndex) {
    var table = document.getElementById("latestInventoryTanksReportTable");
...
function filterTable() {
    ...
    var rows = document.querySelectorAll("#latestInventoryTanksReportTable tbody tr");
...
function changePage(offset) {
    ...
    if (newPage >= 1 && newPage <= totalPages) {
        ...
        window.location.href = `${basePath}/Reports/LatestInventoryTanks?pageNumber=${newPage}&pageSize=${pageSize}`;
    }
}